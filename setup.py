...
setup(name='WISK Tracker',
      ...
      data_files=[('var/config', ['config/wisk_common.cfg',
                                  'config/wisk_install_type.cfg',
                                  'config/wisk_parser.cfg']),
                  ('lib32', ['src/lib32/libwisktrack.so']),
                  ('lib64', ['src/lib64/libwisktrack.so']),
