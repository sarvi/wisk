...
testcases = [
    [0, ('WRITES "/tmp/{testname}/file1"',
     'CHMOD "/tmp/{testname}/file1"',
     'CHMOD "/tmp/{testname}/file2"'),
     TEMPLATE_COMMON+     '''
open('/tmp/{testname}/file1', 'w').close()
os.chmod('/tmp/{testname}/file1', stat.S_IWUSR)
file=open('/tmp/{testname}/file2', 'w')
os.fchmod(file.fileno(), stat.S_IWUSR)
print('Complette')
     '''],
]
